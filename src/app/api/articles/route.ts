...
export async function DELETE() {
  try {
    ...
    console.log(
      "Starting complete database cleanup - deleting all articles and chunks..."
    );
    ...
    console.log(
      `Complete database cleanup completed: ${deletedArticles.count} articles and ${deletedChunks.count} chunks deleted`
    );
